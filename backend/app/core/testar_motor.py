...
# Adiciona o path para importar os módulos do backend
...
def criar_cliente_teste(tipo: str) -> Cliente:
    ...
    clientes = {
        "professor": Cliente(
            ...
            cpf="111.222.333-44",
            data_nascimento=date(1966, 1, 1),  # 60 anos
            sexo="M",
            categoria_segurado="CLT",
            data_filiacao_rgps=date(1991, 1, 1),  # 35 anos
            professor=True,
        ...
        "rural": Cliente(
            ...
            cpf="222.333.444-55",
            data_nascimento=date(1971, 1, 1),  # 55 anos
            sexo="F",
        ...
        "deficiente": Cliente(
            ...
            cpf="444.555.666-77",
            data_nascimento=date(1975, 1, 1),  # 51 anos
            sexo="F",
            categoria_segurado="CLT",
...
def testar_cliente(cliente: Cliente, nome_teste: str):
    ...
    print(f"Tempo Contribuição: {cliente.tempo_contribuicao_anos:.1f} anos")
    ...
    for i, r in enumerate(resultados, 1):
        ...
        if r.detalhes:
            # Mostra apenas detalhes relevantes
            detalhes_filtrados = {k: v for k, v in r.detalhes.items() 
                                 if v is not None and k not in ['erro']}
            if detalhes_filtrados:
                print(f"   📌 {detalhes_filtrados}")
        print()
